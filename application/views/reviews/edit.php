...
<?php echo form_open('reviews/update','',array('rid'=>$RID)); ?>
  ...
  <input type="text" name="title" value="<?php echo $RTITLE ?>"/></br>
  ...
  <input type="radio" name="rating" value="5" <?php if($STARS==5) echo 'checked'?>/>5</br>
  
  <label for="content">Content</label>
  <textarea name="content"><?php echo $RCONTENT ?></textarea></br>
